...
import { useState, useEffect } from "react"; // On importe useEffect
...
export default function LoginPage() {
  ...
  // CORRECTION : On ajoute un état pour s'assurer qu'on est côté client
  ...
  // On attend d'être sur le client ET que l'authentification soit vérifiée
