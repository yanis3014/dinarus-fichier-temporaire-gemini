...
export default function SuggestionsHistoryPage() {
  ...
  useEffect(() => {
    // Dans une vraie application, ces données seraient chargées depuis une API
    const demoSuggestions: SuggestionWithStatus[] = [
      {
        id: '1',
        name: 'Café Eco-friendly',
        address: '15 Rue des Oliviers, Alger',
        category: 'restaurant',
        contactName: 'Mohamed',
        contactPhone: '05 55 12 34 56',
        notes: 'Café proposant des produits biologiques et locaux',
        status: 'added',
      ...
      },
      {
        id: '2',
        name: 'Bio Market',
        address: '22 Avenue de la Liberté, Constantine',
        category: 'groceries',
        contactName: 'Amina',
        notes: 'Épicerie bio avec produits en vrac',
        status: 'contacted',
    ...
    // Récupérer les suggestions stockées dans le localStorage
                ...
                <div>
                  ...
                  <div className="flex items-center bg-yellow-100/50 rounded-lg p-2 mt-1">
                    ...
                    <p className="text-sm text-yellow-800">
                      <strong>500 points étoilés</strong> par commerçant qui rejoint la plateforme grâce à vous !
                    </p>
                  </div>
                </div>
              </div>
